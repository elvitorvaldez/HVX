...
$query="Select Id, Departamento, Puesto from Vacantes where Status=1";
...
?>
 ...
 <center><h4>Vacantes por autorizar</h4></center>
</div>
...
<table id="TablaAut" class="blueTable">
  ...
  while ($fila = mysql_fetch_assoc($resultado)) {   ?> 
    <tr>
      ...
      <td><a href="autorizacionesDetalle.php?Id=<?php echo $fila['Id'];?>" class="btn btn-info"><img src="img/ver.svg" width="20px"></a>
    </tr>
    <?php } ?>
  </tbody>
</table>
