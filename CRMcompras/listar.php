...
Paginador = function(divPaginador, tabla, tamPagina)
{
    ...
    this.Mostrar = function()
    {
     ...
     <center><h4>Listado de Proveedores</h4>  <?php if ($_SESSION['admin']==1)
	 {?> <a href="agregarProveedor.php" class="boton">Agregar Proveedor</a> <?php }?></center>
 ...
 $i=1;
  ...
  ?>
    <tr>
      ...
      <td scope="col"><a href="ver.php?idProveedor=<?php echo $fila['Numero'];?>"><img src="../images/ver.svg" width="20px"></a></td>
      <?php if ($_SESSION['admin']==1) { ?>
      <td scope="col"><a href="formulario.php?idProveedor=<?php echo $fila['Numero'];?>"><img src="../images/editar.svg" width="20px"></a></td>      
